...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll(
        '.timeline-item, .project-item, .education-item'
    );
    ...
    // Separate handling for stats with different animation
    const statElements = document.querySelectorAll('.stat');
    statElements.forEach(stat => {
        stat.style.opacity = '1'; // Keep stats visible
...
document.addEventListener('DOMContentLoaded', () => {
    const aboutContent = document.querySelectorAll('.about-description, .expertise-areas, .domain-expertise');
